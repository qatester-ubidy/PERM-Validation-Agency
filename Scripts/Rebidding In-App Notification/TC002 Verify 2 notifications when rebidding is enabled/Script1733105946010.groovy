...
if (ApplicationNotif == "Application : Declined") {
	...
	WebUI.verifyMatch(ApplicationNotif, "Re-Bid : Enabled", false)
}
...
def expectedText2 = "PureSilver CorpTEST has enabled your application to rebid for Engagement No. "+ GlobalVariable.EngagementNumber + "."
...
if (RebidStatus == "Re-Bid : Enabled") {
	WebUI.verifyMatch(RebidStatus, "Re-Bid : Enabled", false)
} else {
