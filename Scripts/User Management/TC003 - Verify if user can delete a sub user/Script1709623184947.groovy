...
WebUI.click(findTestObject('Object Repository/Account Settings Page/Buttons/Delete User Btn'))

WebUI.click(findTestObject('Object Repository/Account Settings Page/Delete User Modal/Yes Btn'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Account Settings Page/Elements/Delete User Success Toast Msg'), 3)

WebUI.verifyTextPresent("User information has been deleted", false)