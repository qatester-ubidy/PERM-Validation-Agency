...
WebUI.click(findTestObject('Object Repository/Gmail Page/Buttons/Create Password Btn'))

WebUI.switchToWindowIndex(1)

WebUI.click(findTestObject('Object Repository/Gmail Page/Textboxes/New Password Txtbox'))

WebUI.setText(findTestObject('Object Repository/Gmail Page/Textboxes/New Password Txtbox'), GlobalVariable.StandardPw)

WebUI.click(findTestObject('Object Repository/Gmail Page/Textboxes/Retype New Password'))

WebUI.setText(findTestObject('Object Repository/Gmail Page/Textboxes/Retype New Password'), GlobalVariable.StandardPw)

WebUI.click(findTestObject('Object Repository/Gmail Page/Buttons/Create New Password Btn'))

WebUI.callTestCase(findTestCase("Call TestCases/Open Ubidy Agency"), [:])

WebUI.verifyElementPresent(findTestObject('Object Repository/Login Page/Textboxes/Email Textbox'), 3)

WebUI.setText(findTestObject('Object Repository/Login Page/Textboxes/Email Textbox'), GlobalVariable.AddedUserEmail)
