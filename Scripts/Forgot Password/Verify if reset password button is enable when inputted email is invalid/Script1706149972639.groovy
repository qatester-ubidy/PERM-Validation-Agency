...
WebUI.setText(findTestObject('Object Repository/Forgot Password Page/Email Field'), "QA.tester")

WebUI.verifyElementPresent(findTestObject('Object Repository/Login Page/Email Field Validation'), 3)
