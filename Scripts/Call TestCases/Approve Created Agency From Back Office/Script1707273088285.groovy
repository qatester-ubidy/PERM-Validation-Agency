...
WebUI.verifyElementPresent(findTestObject('Object Repository/Back Office - Assesstment Page/Buttons/Approved Btn'), 3)

WebUI.click(findTestObject('Object Repository/Back Office - Assesstment Page/Buttons/Approved Btn'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Back Office - Assesstment Page/Activation Confirmation Modal/Approve Btn'), 3)

WebUI.click(findTestObject('Object Repository/Back Office - Assesstment Page/Activation Confirmation Modal/Approve Btn'))

WebUI.verifyElementText(findTestObject('Object Repository/Back Office - Assesstment Page/Elements/Application Status Field'), "Approved")