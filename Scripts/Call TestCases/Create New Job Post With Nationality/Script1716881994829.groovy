...
WebUI.click(findTestObject('Object Repository/Employer - Talent Request Page/Job Requirements/Create Talent Request Page/Buttons/Prefered Source Location Dropdown Btn'))

WebUI.setText(findTestObject('Object Repository/Employer - Talent Request Page/Job Requirements/Create Talent Request Page/Textboxes/Prefered Source Location Txtbox'),"Africa" + Keys.ENTER)
