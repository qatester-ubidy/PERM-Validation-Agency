...
WebUI.waitForElementPresent(findTestObject('Object Repository/Employer - Candidate Viewer/Elements/Shortlisted Option'), 3)

WebUI.click(findTestObject('Object Repository/Employer - Candidate Viewer/Elements/Shortlisted Option'))
...
WebUI.verifyTextPresent("candidate is now Shortlisted", false)
...
WebUI.setText(findTestObject('Object Repository/Gmail Page/Textboxes/Search Txtbox'), "Candidate Shortlisted")
...
WebUI.click(findTestObject('Object Repository/Gmail Page/Elements/First Email Shortlisted Notif'))

WebUI.verifyTextPresent("Candidate has been shortlisted", false)
