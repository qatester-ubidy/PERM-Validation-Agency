...
WebUI.waitForElementPresent(findTestObject('Object Repository/Employer - Candidate Viewer/Offer Extended Modal/24 hours Option'), 3)

WebUI.click(findTestObject('Object Repository/Employer - Candidate Viewer/Offer Extended Modal/24 hours Option'))

WebUI.click(findTestObject('Object Repository/Employer - Candidate Viewer/Offer Extended Modal/Confirm Btn'))
