...
WebUI.waitForElementPresent(findTestObject('Object Repository/Employer - Candidate Viewer/Elements/Rejected Option'), 3)

WebUI.click(findTestObject('Object Repository/Employer - Candidate Viewer/Elements/Rejected Option'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Employer - Candidate Viewer/Candidate Status Update Modal/Reject Txtarea'), 3)

WebUI.setText(findTestObject('Object Repository/Employer - Candidate Viewer/Candidate Status Update Modal/Reject Txtarea'), "This candidate is rejected.")
...
WebUI.verifyTextPresent("candidate rejected", false)
