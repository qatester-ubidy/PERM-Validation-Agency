...
WebUI.waitForElementPresent(findTestObject('Object Repository/Engagement Page/Buttons/Assigned To You Tab'), 3)

WebUI.click(findTestObject('Object Repository/Engagement Page/Buttons/Assigned To You Tab'))
...
WebUI.verifyTextPresent(GlobalVariable.EngagementNumber, false)
