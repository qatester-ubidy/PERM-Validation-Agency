...
WebUI.verifyElementClickable(findTestObject('Object Repository/Candidate Center/Buttons/All Candidates Tab'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Candidate Center/Buttons/Assigned To You Tab'), 3)

WebUI.verifyElementClickable(findTestObject('Object Repository/Candidate Center/Buttons/Assigned To You Tab'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Candidate Center/Textboxes/Candidate Searchbar'), 3)

WebUI.callTestCase(findTestCase("Call TestCases/Verify All Filter Tabs"), [:])
